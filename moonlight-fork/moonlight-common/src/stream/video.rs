...
unsafe fn convert_decode_unit<'a>(
    ...
    VideoDecodeUnit {
        ...
        receive_time: Duration::from_micros(raw.receiveTimeUs),
        enqueue_time: Duration::from_micros(raw.enqueueTimeUs),
        presentation_time: Duration::from_micros(raw.presentationTimeUs),
