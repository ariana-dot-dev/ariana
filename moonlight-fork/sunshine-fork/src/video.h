...
#undef _CONVERT
  ...
  /**
   * @brief Set a pending bitrate change (in kbps).
   * The encoding loop will pick this up and recreate the encoder with the new bitrate.
   * @param bitrate_kbps New bitrate in kilobits per second. Set to 0 to clear.
   */
  void set_pending_bitrate(int bitrate_kbps);

  /**
   * @brief Get and clear the pending bitrate.
   * @return The pending bitrate in kbps, or 0 if no change is pending.
   */
